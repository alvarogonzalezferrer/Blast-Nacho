             ...
             if (ene[i2].energia > 0 )
                ...
                if (( dispjug[i].x < ene[i2].x / 10 + enemigo_bmp[0]->w ) &&
                    ...
                    ( dispjug[i].y + shoot_jugador_bmp->h/2 > ene[i2].y / 10 ) )
                    {
                        ...
                        play_sample(grito_enemigo_snd[rand()%4], 255, 128, 1000, 0);
                        ...
                        agregar_particulas(dispjug[i].x,
                         ...
                         sumar_puntaje_mensaje(ene[i2].x,ene[i2].y, rand()%1000+100, &jug.puntaje);
                         ...
                         switch (rand()%10)
                           {
                             ...
                             case 1:
                             case 2:
                                 agregar_premio(dispjug[i].x, dispjug[i].y, premio_bmp[1], premio_snd[1], rand()%500+250, rand()%3);
                             break;
                             ...
                             case 4:
                             case 5:
                                 agregar_premio(dispjug[i].x, dispjug[i].y, premio_bmp[2], premio_snd[2], rand()%1000+750, rand()%4);
                             break;

                             // Diamante
                             case 6:
                             case 7:
                                 agregar_premio(dispjug[i].x, dispjug[i].y, premio_bmp[3], premio_snd[3], rand()%2000+2000, rand()%4);
                             break;
                        ...
                        // particulas
                             agregar_particulas(dispjug[i].x,
                                                ...
                                                particula_color);  
                         // puntaje
                         jug.puntaje += rand()%100+10;

                         // debug: mensaje de dolor...
                         if (rand()%100 < 25) agregar_mensaje_dolor(ene[i2].x, ene[i2].y);
                        }
